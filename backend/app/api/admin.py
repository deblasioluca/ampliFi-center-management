...
UPLOAD_TEMPLATES: dict[str, dict] = {
    "cost_centers": {
        ...
        "description": "Cost center upload — SAP CSKS/CSKT structure",
        "columns": [
            "MANDT",
            "KOKRS",
            "KOSTL",
    ...
    "profit_centers": {
        ...
        "description": "Profit center upload — SAP CEPC/CEPCT structure",
        "columns": [
            "MANDT",
            "KOKRS",
            "PRCTR",
    ...
    "entities": {
        ...
        "description": "Entity (company code) upload — SAP T001 structure",
        "columns": [
            "MANDT",
            "BUKRS",
            "BUTXT",
