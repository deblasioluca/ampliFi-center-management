...
UPLOAD_TEMPLATES: dict[str, dict] = {
    "cost_centers": {
        ...
        "columns": [
            ...
            "BKZKP", "PKZKP", "BUKRS", "GSBER", "KOSAR",
            "VERAK", "VERAK_USER", "WAERS", "KALSM", "TXJCD",
            "PRCTR", "WERKS", "LOGSYSTEM",
            "ERSDA", "USNAM", "BKZKS", "BKZER", "BKZOB",
            "PKZKS", "PKZER", "VMETH", "MGEFL",
            "ABTEI", "NKOST", "KVEWE", "KAPPL", "KOSZSCHL",
            "LAND1", "ANRED", "NAME1", "NAME2", "NAME3", "NAME4",
            "ORT01", "ORT02", "STRAS", "PFACH", "PSTLZ", "PSTL2",
            "REGIO", "SPRAS",
            "TELBX", "TELF1", "TELF2", "TELFX", "TELTX", "TELX1",
            "DATLT", "DRNAM", "KHINR", "CCKEY", "KOMPL", "STAKZ",
            "OBJNR", "FUNKT", "AFUNK",
            "CPI_TEMPL", "CPD_TEMPL", "FUNC_AREA",
            "SCI_TEMPL", "SCD_TEMPL", "SKI_TEMPL", "SKD_TEMPL",
            "ZZCUEMNCFU", "ZZCUEABACC", "ZZCUEGBCD", "ZZCUEUBCD",
            "ZZCUENKOS", "ZZSTRPCTYP", "ZZSTRKKLAS", "ZZSTRAAGCD",
            "ZZSTRGFD", "ZZSTRFST", "ZZSTRMACVE", "ZZSTRABUKR",
            "ZZSTRUGCD", "ZZSTRINADT", "ZZSTRKSTYP", "ZZSTRVERIK",
            "ZZSTRCURR2", "ZZSTRLCCID", "ZZSTRMALOC", "ZZSTRTAXCD",
            "ZZSTRGRPID", "ZZSTRREGCODE", "ZZSTRTAXAREA", "ZZSTRREPSIT",
            "ZZSTRGSM", "ZZCEMAPAR", "ZZLEDGER", "ZZHDSTAT", "ZZHDTYPE",
            "ZZFMD", "ZZFMDCC", "ZZFMDNODE", "ZZSTATE", "ZZTAX",
            "ZZSTRENTSA", "ZZSTRENTZU", "XBLNR",
            "VNAME", "RECID", "ETYPE", "JV_OTYPE", "JV_JIBCL",
            "JV_JIBSA", "FERC_IND",
            "KTEXT", "LTEXT",
        ],
        "sample_row": [],
    ...
    "profit_centers": {
        ...
        "columns": [
            "MANDT", "PRCTR", "DATBI", "KOKRS", "DATAB",
            "ERSDA", "USNAM", "MERKMAL", "ABTEI",
            "VERAK", "VERAK_USER", "WAERS", "NPRCTR",
            "LAND1", "ANRED", "NAME1", "NAME2", "NAME3", "NAME4",
            "ORT01", "ORT02", "STRAS", "PFACH", "PSTLZ", "PSTL2",
            "SPRAS",
            "TELBX", "TELF1", "TELF2", "TELFX", "TELTX", "TELX1",
            "DATLT", "DRNAM", "KHINR",
            "BUKRS", "VNAME", "RECID", "ETYPE", "TXJCD", "REGIO",
            "KVEWE", "KAPPL", "KALSM", "LOGSYSTEM",
            "LOCK_IND", "PCA_TEMPLATE", "SEGMENT",
            "KTEXT", "LTEXT",
        ],
        "sample_row": [],
    },
    ...
    "entities": {
        ...
        "columns": [
            ...
            "ADRNR", "STCEG", "FIKRS", "XFMCO", "XFMCB", "XFMCA",
            "TXJCD", "FMHRDATE", "BUVAR", "FDBUK",
            "XFDIS", "XVALV", "XSKFN", "KKBER",
            "XMWSN", "MREGL", "XGSBE", "XGJRV",
            "XKDFT", "XPROD", "XEINK", "XJVAA",
            "XVVWA", "XSLTA", "XFDMM", "XFDSD", "XEXTB",
            "EBUKR", "KTOP2", "UMKRS", "BUKRS_GLOB",
            "FSTVA", "OPVAR", "XCOVR", "TXKRS", "WFVAR",
            "XBBBF", "XBBBE", "XBBBA", "XBBKO", "XSTDT",
            "MWSKV", "MWSKA", "IMPDA", "XNEGP", "XKKBI",
            "WT_NEWWT", "PP_PDATE", "INFMT", "FSTVARE",
            "KOPIM", "DKWEG", "OFFSACCT", "BAPOVAR",
            "XCOS", "XCESSION", "XSPLT", "SURCCM",
            "DTPROV", "DTAMTC", "DTTAXC", "DTTDSP", "DTAXR",
            "XVATDATE", "PST_PER_VAR", "XBBSC", "F_OBSOLETE",
        ],
        "sample_row": [],
    },
    "hierarchies": {
    ...
    "employees": {
        ...
        "columns": [
            "MANDT", "GPN", "NAME", "VORNAME",
            "SPRACHENSCHLUESS", "ANREDECODE", "USERID",
            "EINTRITTSDATUM", "OE_LEITER",
            "INT_TEL_NR_1AP", "EXT_TEL_NR_1AP", "NL_CODE_GEB_1AP",
            "STRASSE_GEB_1AP", "STOCKWERK_1AP", "BUERONUMMER_1AP",
            "KSTST", "KSTST_TEXT", "OE_OBJEKT_ID", "OE_CODE", "OE_TEXT",
            "SAP_BUKRS", "SAP_BUKRS_TEXT", "T_NUMMER",
            "INSTRAD_1", "INSTRAD_2", "KSTST_EINSATZ_OE",
            "PERSONALBER_TEXT", "NL_OE_MA", "NL_TEXT",
            "GSFLD_OE_MA", "GSFLD_OE_MA_TEXT",
            "MA_GRUPPE", "MA_GRUPPE_TEXT", "MA_KREIS", "MA_KREIS_TEXT",
            "RANG_CODE", "RANG_TEXT", "AKADEMISCHER_TIT",
            "UBS_FUNK", "UBS_FUNK_TEXT",
            "GPN_VG_MA", "NAME_VG_MA",
            "UEG_OE_OBJEKTID", "UEG_OE_BEZ", "UEG_OE_KRZ",
            "BSCHGRAD", "PERSONALBEREICH", "FAX_EXT_1AP",
            "EMAIL_ADRESSE", "MA_KZ", "FIRMA_EXT_MA",
            "BEGDAT_ORGWECHS", "AUSTRITT_DATUM",
            "NATEL_NUMMER", "PAGER_NUMMER",
            "PLZ_GEB_1AP", "ORT_GEB_1AP",
            "EINSATZ_OE_KRZ", "EINSATZ_OE_TEXT",
            "DIVISION", "GEB_COD_1AP", "RANG_KRZ", "SYSTEMDATUM",
            "AP_NUMMER", "EINSATZ_OE_OBJID",
            "INT_TEL_NR_2AP", "EXT_TEL_NR_2AP", "BUERONUMMER_2AP",
            "GEB_COD_2AP", "STRASSE_GEB_2AP", "PLZ_GEB_2AP",
            "ORT_GEB_2AP", "GEB_COD_GEB_2AP", "FAX_NR_2AP", "STOCKWERK_2AP",
            "GPIN_NUMMER", "NAT",
            "LAND_GEB_1AP", "REG_NR_1AP", "POSTF_1AP",
            "PLZ_POSTFADR_1AP", "ORT_POSTFADR_1AP",
            "LAND_GEB_2AP", "REG_NR_2AP", "POSTF_2AP",
            "PLZ_POSTFADR_2AP", "ORT_POSTFADR_2AP",
            "LETZTER_ARB_TAG", "ABAC_NL_AG_EINOE",
            "VERTR_ENDE_EXMA", "UNTERGRP_CODE",
            "BS_FIRST_NAME", "BS_LAST_NAME",
            "NAME_UC", "VORNAME_UC", "NAME_PH", "VORNAME_PH",
            "MA_OE", "UPDATED_ID", "MA_KSTST", "BUSINESS_NAME",
            "JOB_CATEG_CODE", "JOB_CATEG_DESCR",
            "COSTCENTER_CODE", "COSTCENTER_DESCR",
            "MANACS_FUNC_CODE", "MANACS_FUNC_DESC",
            "MANACS_SEGM_CODE", "MANACS_SEGM_DESC",
            "MANACS_SECT_CODE", "MANACS_SECT_DESC",
            "MANACS_BSAR_CODE", "MANACS_BSAR_DESC",
            "MANACS_BSUN_CODE", "MANACS_BSUN_DESC",
            "MANACS_BSGP_CODE", "MANACS_BSGP_DESC",
            "MANACS_REG_CODE", "MANACS_REG_DESCR",
            "MANACS_LOC_CODE", "MANACS_LOC_DESCR",
            "REGULATORY_REG", "SUPERVISORS_GPIN",
            "UUNAME", "WEB_SSO", "SAP_USER",
            "HR_COMPANY", "REGULATORY_REGST", "GLOBAL_CC",
        ],
        "sample_row": [],
    },
}
